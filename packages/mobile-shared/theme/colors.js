...
export const colors = {
  ...
  // ==========================================
  // 8. ALIAS DE COMPATIBILIDAD (pantallas oscuras del dueño)
  // Claves referenciadas por las pantallas heredadas de apps/mobile;
  // ya existían sin definir en el proyecto original — se completan aquí
  // para que no queden estilos con valores undefined.
  // ==========================================
  dark: "#061E1F",
  white: "#FFFFFF",
  info: "#2E7375",
