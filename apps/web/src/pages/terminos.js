  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-brand-ink pt-32 pb-24 relative overflow-hidden">
        {/* Ambient glow */}
        <div className="absolute top-24 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-brand-teal/10 rounded-full filter blur-[120px] pointer-events-none" />
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 relative z-10 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-2xl bg-white border border-brand-line p-5 space-y-2 shadow-lg">
              <ShieldCheck className="h-5 w-5 text-brand-tealInk" />
              <h3 className="text-sm font-bold text-brand-ink">Deducible 15 UF (50/50)</h3>
            ...
            <div className="rounded-2xl bg-white border border-brand-line p-5 space-y-2 shadow-lg">
              <Lock className="h-5 w-5 text-brand-tealInk" />
              <h3 className="text-sm font-bold text-brand-ink">Hold de $800.000 CLP</h3>
              <p className="text-xs text-[#63645f]">
          ...
          <div className="rounded-3xl bg-white border border-brand-line p-6 sm:p-10 space-y-8 text-xs sm:text-sm text-[#63645f] leading-relaxed shadow-2xl">
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">2.</span> Requisitos para Arrendatarios
              </h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">4.</span> Hold de Garantía ($800.000 CLP) y Devolución
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">5.</span> Checklist Obligatorio de 9 Fotos e Inspección Inmutable
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">6.</span> Kilometraje, Combustible y TAG
              </h2>
              <ul className="list-disc pl-5 space-y-1.5 text-[#63645f]">
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">7.</span> Cancelaciones y Modificaciones
              </h2>
              <p>
            ...
            <div className="p-4 rounded-2xl bg-white border border-brand-line flex items-start gap-3">
              <AlertCircle className="h-5 w-5 text-brand-tealInk shrink-0 mt-0.5" />
