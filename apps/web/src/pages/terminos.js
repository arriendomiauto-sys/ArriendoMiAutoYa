  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#060B16] text-white pt-32 pb-24 relative overflow-hidden">
        {/* Ambient glow */}
        <div className="absolute top-24 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-[#FBBF24]/5 rounded-full filter blur-[120px] pointer-events-none" />
          ...
          <div className="rounded-3xl bg-[#0A1124] border border-white/10 p-6 sm:p-10 space-y-8 text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">1.</span> Naturaleza del Servicio y Objeto
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">2.</span> Requisitos para Arrendatarios
              </h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">3.</span> Seguro, Siniestros y Deducible 15 UF (50/50)
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">4.</span> Hold de Garantía ($800.000 CLP) y Devolución
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">5.</span> Checklist Obligatorio de 9 Fotos e Inspección Inmutable
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">6.</span> Kilometraje, Combustible y TAG
              </h2>
              <ul className="list-disc pl-5 space-y-1.5 text-slate-300">
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                <span className="text-[#FBBF24]">7.</span> Cancelaciones y Modificaciones
              </h2>
              <p>
            ...
            <div className="p-4 rounded-2xl bg-[#060B16] border border-white/10 flex items-start gap-3">
              <AlertCircle className="h-5 w-5 text-[#FBBF24] shrink-0 mt-0.5" />
              <div className="text-xs text-slate-300">
                ¿Tienes dudas sobre los términos o coberturas? Contáctanos a través de nuestro{" "}
                <Link href="/garantias" className="text-[#FBBF24] font-bold hover:underline">
                  Centro de Garantías
                </Link>{" "}
