  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-brand-ink pt-32 pb-24 relative overflow-hidden">
        {/* Ambient glow */}
        <div className="absolute top-24 right-1/3 w-[600px] h-[350px] bg-brand-teal/10 rounded-full filter blur-[120px] pointer-events-none" />
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 relative z-10 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-2xl bg-white border border-brand-line p-5 space-y-2 shadow-lg">
              <Shield className="h-5 w-5 text-brand-tealInk" />
              <h3 className="text-sm font-bold text-brand-ink">Encriptación SSL</h3>
            ...
            <div className="rounded-2xl bg-white border border-brand-line p-5 space-y-2 shadow-lg">
              <Eye className="h-5 w-5 text-brand-tealInk" />
              <h3 className="text-sm font-bold text-brand-ink">Cero Comercialización</h3>
              <p className="text-xs text-[#63645f]">
            ...
            <div className="rounded-2xl bg-white border border-brand-line p-5 space-y-2 shadow-lg">
              <FileCheck className="h-5 w-5 text-brand-tealInk" />
              <h3 className="text-sm font-bold text-brand-ink">Custodia Fotográfica</h3>
              <p className="text-xs text-[#63645f]">
          ...
          <div className="rounded-3xl bg-white border border-brand-line p-6 sm:p-10 space-y-8 text-xs sm:text-sm text-[#63645f] leading-relaxed shadow-2xl">
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">2.</span> Información que Recopilamos
              </h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">3.</span> Finalidad del Uso de Datos
              </h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base sm:text-lg font-bold text-brand-ink flex items-center gap-2">
                <span className="text-brand-tealInk">4.</span> Derechos del Titular (ARCO)
              </h2>
              <p>
