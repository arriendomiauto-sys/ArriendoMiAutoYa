...
from app.features.vehicles.gps_tracking.base_provider import BaseGPSProvider
...
class GPSManager:
    ...
    def get_provider(cls) -> BaseGPSProvider:
        ...
        from app.features.vehicles.gps_tracking.providers.mock_provider import MockGPSProvider
