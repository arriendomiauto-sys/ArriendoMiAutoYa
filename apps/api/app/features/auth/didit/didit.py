...
def interpretar_payload(payload: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    # Se priorizan las capturas directas de cámara y liveness en alta resolución
    # para evitar el recorte granulado y de baja calidad del carnet (portrait_image).
    foto = (
        _buscar(face, "source_image", "reference_image", "target_image")
        or _buscar(live, "reference_image", "audit_trail_image", "selfie_image", "full_frame_image")
