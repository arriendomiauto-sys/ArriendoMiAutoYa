  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Switch a Dueño de Auto si lo desea */}
        {onSwitchToOwner && (
          <TouchableOpacity style={styles.switchModeCard} onPress={onSwitchToOwner} activeOpacity={0.85}>
            <View style={{ flex: 1 }}>
              <Text style={styles.switchModeTitle}>¿Tienes un auto para arrendar?</Text>
              <Text style={styles.switchModeSub}>Publica tu auto y gana ingresos con la App de Dueño</Text>
            </View>
