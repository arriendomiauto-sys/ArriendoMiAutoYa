  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Switch a Usuario Arrendatario si lo desea */}
        {onSwitchToRenter && (
          <TouchableOpacity style={styles.switchModeCard} onPress={onSwitchToRenter} activeOpacity={0.85}>
            <View style={{ flex: 1 }}>
              <Text style={styles.switchModeTitle}>¿Deseas arrendar un auto?</Text>
              <Text style={styles.switchModeSub}>Cambiar a la App de Arrendatario</Text>
            </View>
