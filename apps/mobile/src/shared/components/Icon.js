...
export function Icon({
  ...
  // Renderizador SVG para Web y Multiplataforma
  ...
  switch (name) {
    ...
    // 7. Estrella Real (Rating / Calificaciones)
    case "star":
    case "estrella":
      return renderSvg(
        <path
